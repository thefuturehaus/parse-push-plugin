...
Add the following to your config.xml. The plugin will read these values so you don't have to manually modify
AppDelegate.m

```xml
<preference name="ParseAppId" value="YOUR_PARSE_APPID" />
<preference name="ParseClientKey" value="YOUR_PARSE_CLIENT_KEY" />
```
